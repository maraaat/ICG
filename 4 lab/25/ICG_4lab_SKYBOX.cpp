...
unsigned int cCube;
const char *skybox[6] = { "kran/right.jpg", "kran/left.jpg" , "kran/top.jpg" , "kran/bottom.jpg", "kran/front.jpg", "kran/back.jpg"};
...
int main(void)
{
    ...
    window = glfwCreateWindow(1200, 720, "World", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
